...
const STRINGS: Record<string, { ja: string; en: string }> = {
  ...
  'lib.search': { ja: 'タイトルで検索', en: 'Search titles' },
  'lib.sortNew': { ja: '新しい順', en: 'Newest' },
  'lib.sortName': { ja: '名前順', en: 'Name' },
  'lib.deleted': { ja: '削除しました', en: 'Deleted' },
  'lib.undo': { ja: '元に戻す', en: 'Undo' },
  'lib.reveal': { ja: 'ファイルの場所を開く', en: 'Show in folder' },
  'lib.removeTake': { ja: 'このテイクを削除', en: 'Delete this take' },
  'lib.removeTakeConfirm': { ja: 'もう一度押すと削除', en: 'Click again to delete' },
  'lib.dropRefZone': { ja: 'リファレンスとして登録', en: 'Set as reference' },
  'lib.dropOwnZone': { ja: '自分のボーカルとして追加', en: 'Add as your vocal' },
  'lib.emptyAction': { ja: 'クリックしてファイルを選択', en: 'Click to pick files' },
  'cmp.backToLibrary': { ja: 'ライブラリへ', en: 'Go to library' },
  'cmp.analysisFailed': { ja: '解析に失敗しました', en: 'Analysis failed' },
  'cmp.loopHint': { ja: 'ドラッグでループ区間を選択', en: 'Drag to select a loop' },
  'cmp.shortcuts': { ja: 'キーボードショートカット', en: 'Keyboard shortcuts' },
  'cmp.sc.play': { ja: '再生 / 停止', en: 'Play / stop' },
  'cmp.sc.ab': { ja: 'A/B 切替', en: 'Switch A/B' },
  'cmp.sc.seek': { ja: '5秒戻し / 送り', en: 'Seek ±5 s' },
  'cmp.sc.loop': { ja: 'ループ解除', en: 'Clear loop' },
  'cmp.sc.help': { ja: 'このヘルプ', en: 'This help' },
  'notif.sepDone': { ja: '分離が完了しました', en: 'Separation finished' },
  'notif.sepError': { ja: '分離に失敗しました', en: 'Separation failed' },
  'set.nav.engine': { ja: '解析エンジン', en: 'Engine' },
  'set.engineStatus': { ja: 'エンジンの状態', en: 'Engine status' },
  'set.engineStatusSub': {
    ja: 'ボーカル分離・解析エンジン (Python 実行環境 + AIモデル) の導入状況',
    en: 'Install state of the separation / analysis engine (Python runtime + AI models)'
  },
  'set.engineOk': { ja: 'セットアップ済み', en: 'Installed' },
  'set.engineMissing': { ja: '未セットアップ', en: 'Not installed' },
  'set.engineChecking': { ja: '確認中…', en: 'Checking…' },
  'set.engineInstall': { ja: 'ダウンロードしてセットアップ', en: 'Download & set up' },
  'set.engineNote': {
    ja: '約1.8GBをダウンロードします。処理はすべてローカルで実行され、音声が外部に送信されることはありません。',
    en: 'Downloads about 1.8 GB. Everything runs locally — your audio never leaves this machine.'
  }
}
