...
const STRINGS: Record<string, { ja: string; en: string }> = {
  ...
  'lib.addOwn': { ja: '自分のボーカルを追加', en: 'Add your vocal' },
  'lib.compare': { ja: '比較する', en: 'Compare' },
  'lib.stemDragHint': { ja: 'チップをDAWへドラッグで書き出し', en: 'Drag chips into your DAW' },
  'lib.tagAdd': { ja: 'タグ追加', en: 'Add tag' },
  ...
  'cmp.spectrum': { ja: 'スペクトラム', en: 'Spectrum' },
